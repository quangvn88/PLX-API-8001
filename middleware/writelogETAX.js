const { loggerETAX } = require("../logs/config");

module.exports.writeLogETAX = async (req, res, next) => {
...
module.exports.checkAuthETAX = async (req, res, next) => {
    // Check auth
    const auth = {
        login: process.env.API_ETAX_AUTH_USER,
