...
router.use(
  "/:server/mobile/auth",
  writeLogMobile,
  require("./MOBILE/Authentication.route"),
);
router.use(
  "/:server/mobile/api",
  checkJWT,
  writeLogMobile,
  require("./MOBILE/UserFunction.route"),
);
router.use(
  "/:server/mobile/api",
  checkJWT,
  writeLogMobile,
  require("./MOBILE/AdminFunction.route"),
);
...
const {
  checkAuthPLATTS,
  writeLogPLATTS,
} = require("../middleware/writelogPLATTS");
router.use(
  "/:server/platts/api",
  writeLogPLATTS,
  checkAuthPLATTS,
...
const {
  checkAuthPLXID,
  writeLogPLXID,
} = require("../middleware/writelogPLXID");
router.use(
  "/:server/plxid/api",
  writeLogPLXID,
  checkAuthPLXID,
...
// SMO
const { checkAuthSMO, writeLogSMO } = require("../middleware/writelogSMO");
router.use("/smo/api", writeLogSMO, checkAuthSMO, require("./SMO"));
...
// GOOGLE MAP
router.use("/:server/map", require("./GOOGLE_MAP"));
